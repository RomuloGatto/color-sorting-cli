...
from harmony.color_sorting.service_layer.sorting_strategies import StepSorting


class TestStepSorting:
    """Tests for the stepped sorting strategy"""
    ...
    def _when_sorter_set_to_step_strategy(
        ...
        return StepSorting().sort(set(arrangement))

    def _then_should_step_sort(self, result: Tuple[core.Color, ...]) -> None:
